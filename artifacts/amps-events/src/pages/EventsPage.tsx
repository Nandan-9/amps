              ...
              <div className="flex items-end justify-between mb-10">
                <div>
                  ...
                  >
                    ...
                    <span className="text-5xl md:text-7xl font-black uppercase tracking-widest text-transparent group-hover:text-cyan-300 group-hover:drop-shadow-[0_0_25px_rgba(34,211,238,0.9)] transition-all duration-500" style={{ WebkitTextStroke: '1.5px rgba(34,211,238,0.7)', fontFamily: 'var(--app-font-headline)' }}>Don't Miss</span>
                  </motion.div>
            ...
            <div className="flex items-end justify-between mb-10">
              <div>
                ...
                >
                  ...
                  <span className="text-5xl md:text-7xl font-black uppercase tracking-widest text-transparent group-hover:text-purple-300 group-hover:drop-shadow-[0_0_25px_rgba(192,132,252,0.9)] transition-all duration-500" style={{ WebkitTextStroke: '1.5px rgba(192,132,252,0.7)', fontFamily: 'var(--app-font-headline)' }}>Browse</span>
                </motion.div>
                <h2 style={{ fontFamily: 'var(--app-font-headline)', fontSize: 'clamp(36px,5vw,72px)', letterSpacing: '0.04em', lineHeight: 0.95 }} className="text-white">
